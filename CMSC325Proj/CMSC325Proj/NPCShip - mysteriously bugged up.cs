    ...
    class NPCShip : BasicSpaceshipActor
    {
        ...
        public override void UpdateActions(GameTime gameTime)
        {
            ...
            if (gameTime.TotalGameTime.TotalMilliseconds > last_nav_AI + nav_AI_period)
            {
                ...
                separation = (Game1.main_instance.protagonist.world.Translation - world.Translation).Length() / velocity.Length(); // approximate time to close with target, still grows in inaccuracy at higher speeds
                prediction = Game1.main_instance.protagonist.world.Translation + Game1.main_instance.protagonist.velocity * separation * skillz;
            ...
            {
                prediction = Game1.main_instance.protagonist.world.Translation + Game1.main_instance.protagonist.velocity * separation * skillz; // run prediction all the time, for aiming, duh
            }
            ...
            if (!Game1.TestLineSphereIntersection(world.Translation, world.Translation + world.Forward * 6000, prediction, 30f - 29.5f*skillz))
